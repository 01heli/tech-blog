    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-muted text-sm mt-1">共 {articles.length} 篇文章</p>
        </div>
        <Link
      ...
      {articles.length === 0 ? (
        <div className="text-center py-24 text-muted">
          ...
          <p className="text-sm">点击&ldquo;新建文章&rdquo;开始创作</p>
        </div>
      ) : (
              ...
              {articles.map((article) => (
                ...
                >
                  ...
                  <td className="px-5 py-3 hidden md:table-cell">
                    <span className="inline-block px-2 py-0.5 rounded text-xs bg-black/5 dark:bg-white/5 text-muted">
